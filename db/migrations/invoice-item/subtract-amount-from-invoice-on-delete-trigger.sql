CREATE OR REPLACE FUNCTION subtract_amount_from_invoice_on_delete()
  RETURNS trigger AS $subtract_amount_from_invoice_on_delete$
    BEGIN
        UPDATE invoices
          SET amount = (coalesce(amount, 0) - (OLD.unit_price * OLD.quantity)::numeric(10,2))
